    ...
    <div>
      ...
      <v-toolbar flat color="white">
        ...
        <template v-slot:activator="{ on }">
          <v-btn color="primary" dark class="mb-2" :to="'/addgroup'">New group</v-btn>
          </template>
          <v-card>
            <v-card-title>
            ...
            <v-card-text>
              <v-container grid-list-md>
                <v-layout wrap>
                  ...
                  <v-flex xs12 sm6 md4>
                    <v-text-field v-model="editedItem.teachersName" label="Teacher's name"></v-text-field>
                  </v-flex>
                  <v-flex xs12 sm6 md4>
                    <v-text-field v-model="editedItem.quantity" label="Quantity of students"></v-text-field>
                  </v-flex>
                </v-layout>
              </v-container>
            </v-card-text>
